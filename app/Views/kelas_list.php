...
<a href="<?= site_url('kelas/insert') ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Insert</a>
<br /> <br />
    ...
    <tbody>
        ...
        <?php foreach ($list as $row) : ?>
            <tr>
                ...
                <td><?= $row['fasilitas']; ?></td>
                <td nowrap>
                    <a href="<?= site_url('kelas/' . $row['kode_kelas']) ?>" class="btn btn-info"><i class="fas fa-edit"></i> Update</a>
                </td>
            </tr>
        <?php endforeach ?>
    </tbody>
